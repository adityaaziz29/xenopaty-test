...
<head>
    ...
    <title>Data Employee - DityaLabs</title>
...
<body style="background: lightgray">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h3 class="text-center">DityaLabs</h3>         
                    <hr>
                </div>
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('employees.create') }}" class="btn btn-md btn-success mb-3">TAMBAH EMPLOYEE</a>
                              ...
                              @forelse ($employees as $employee)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/employees/'.$employee->user_picture) }}" class="rounded" style="width: 150px">
                                    </td>
                                    <td class="text-center">
